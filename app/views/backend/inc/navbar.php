<nav class="navbar navbar-expand-lg dashboard-nav">
    <div class="container-fluid">
        <a class="navbar-brand" href="/home/dashboard">Admin Dashboard</a>
...
<!--                    <img src="--><?php //= $_SESSION['profile_picture']; ?><!--" alt="Profile Image" class="rounded-circle me-2" style="width: 32px; height: 32px;">-->
                    <?php if (empty($_SESSION['profile_picture'])) : ?>
                        <img src="/images/default.jpg" class="rounded-circle" style="width: 32px; height: 32px;" alt="Default Profile Picture">
                    <?php else : ?>
